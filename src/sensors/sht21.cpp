...
sht21::sht21() : Sensor("sht21") {this->sht.begin() ? this->status = Sensor::StatusReady: (this->status = Sensor::StatusError)&&(this->error = Sensor::ErrorNotFound); 
...
Sensor::SensorMesureData *sht21::read() { return this->mesuresDatas; }
